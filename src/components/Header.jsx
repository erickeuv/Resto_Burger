  ...
  return (
    <nav className="w-full bg-gray-900 p-4 text-white sticky top-0 shadow-lg z-[9999]">
      <div className="flex items-center justify-between mx-auto max-w-7xl">
        ...
        <button
          className="relative h-6 w-6 text-center align-middle text-xs font-medium uppercase text-white transition-all hover:bg-transparent focus:bg-transparent lg:hidden"
          type="button"
        >
